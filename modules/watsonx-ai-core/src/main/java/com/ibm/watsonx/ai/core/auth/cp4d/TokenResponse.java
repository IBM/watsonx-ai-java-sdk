...
/**
 * Represents the response body returned by the Cloud Pak for Data authentication endpoint.
 *
 ...
 * @param expiration UNIX timestamp indicating when the IAM access token expires.
