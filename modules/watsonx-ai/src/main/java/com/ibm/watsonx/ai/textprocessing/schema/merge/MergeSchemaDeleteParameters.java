...
public final class MergeSchemaDeleteParameters extends WatsonxParameters {
    ...
    public boolean equals(Object obj) {
        ...
        if (!super.equals(obj))
            return false;
        MergeSchemaDeleteParameters other = (MergeSchemaDeleteParameters) obj;
        if (hardDelete == null) {
    ...
    public String toString() {
        return "MergeSchemaDeleteParameters [projectId=" + projectId + ", spaceId=" + spaceId + ", transactionId=" + transactionId + ", hardDelete="
            + hardDelete + "]";
    }
}
