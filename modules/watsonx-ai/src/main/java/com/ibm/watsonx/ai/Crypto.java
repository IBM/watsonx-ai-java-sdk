 ...
 * <p>
 * This record encapsulates the key reference identifier from a keys management service used to enable encryption of requests.
 *
 * @param keyRef the key reference identifier from a keys management service
 * @see <a href=
