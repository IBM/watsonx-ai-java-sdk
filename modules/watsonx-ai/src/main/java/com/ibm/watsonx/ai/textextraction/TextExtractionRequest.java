...
public record TextExtractionRequest(String projectId, String spaceId, DataReference documentReference, DataReference resultsReference,
  ...
  public static class Schema {
    ...
    public static class Builder {
      ...
      /**
       * Sets mapping of fields to identify within the schema, where each key is the short-form name of the field, and the corresponding value is an
       * object is a schema as defined below.
       *
