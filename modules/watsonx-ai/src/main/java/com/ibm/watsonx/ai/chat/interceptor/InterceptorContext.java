...
public final class InterceptorContext {
    ...
    private final BaseChatRequest request;
    private final ChatResponse response;

    public InterceptorContext(ChatProvider chatProvider, BaseChatRequest request, ChatResponse response) {
    ...
    /**
     * Returns the {@link BaseChatRequest}.
     *
     * @return the chat request
     */
    public BaseChatRequest request() {
        return request;
    }
     ...
     */
    public ChatResponse invoke(BaseChatRequest request) {
