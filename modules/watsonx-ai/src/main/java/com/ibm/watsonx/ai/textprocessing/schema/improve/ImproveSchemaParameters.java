...
/**
 * Represents a set of parameters used to control the behavior of an improve schema operation.
 * <p>
 ...
 *
 * <pre>{@code
 * ImproveSchemaParameters.builder()
 ...
 *
 */
public final class ImproveSchemaParameters extends WatsonxParameters {
    private final SemanticConfig semanticConfig;
    private final Duration timeout;

    private ImproveSchemaParameters(Builder builder) {
        super(builder);
     ...
     */
    protected Parameters toParameters(Schema schema) {
        ...
        return new Parameters(schema, semanticConfigRecord);
    }
    ...
    /**
     * Builder class for constructing {@link ImproveSchemaParameters} instances.
     */
    public static class Builder extends WatsonxParameters.Builder<Builder> {
        ...
        /**
         * Builds an {@link ImproveSchemaParameters} instance using the configured parameters.
         *
         * @return a new instance of {@link ImproveSchemaParameters}
         */
        public ImproveSchemaParameters build() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!super.equals(obj))
            return false;
        ImproveSchemaParameters other = (ImproveSchemaParameters) obj;
        if (semanticConfig == null) {
    ...
    public String toString() {
        return "ImproveSchemaParameters [projectId=" + projectId + ", spaceId=" + spaceId + ", transactionId=" + transactionId + ", semanticConfig="
