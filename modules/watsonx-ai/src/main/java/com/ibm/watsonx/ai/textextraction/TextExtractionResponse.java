...
public record TextExtractionResponse(Metadata metadata, Entity entity) {
   ...
   *
   * @param status The status of the extraction request. Possible values: {@code submitted}, {@code uploading}, {@code running}, {@code downloading},
   *          {@code downloaded}, {@code completed}, {@code failed}.
