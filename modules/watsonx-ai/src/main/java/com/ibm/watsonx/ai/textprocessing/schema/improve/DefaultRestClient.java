...
/**
 * Default implementation of the {@link ImproveSchemaRestClient} abstract class.
 */
final class DefaultRestClient extends ImproveSchemaRestClient {
    ...
    public ImproveSchemaResponse fetchRequestDetails(ImproveFetchDetailsRequest request) {
        ...
        try {
            ...
            return fromJson(httpResponse.body(), ImproveSchemaResponse.class);
    ...
    public ImproveSchemaResponse startRequest(StartImproveSchemaRequest request) {
        var httpRequest =
            HttpRequest.newBuilder(URI.create(baseUrl + "/ml/v1/text/schemas/improve?version=%s".formatted(version)))
                .header("Content-Type", "application/json")
                .header("Accept", "application/json")
                .POST(BodyPublishers.ofString(toJson(request.improveSchemaRequest())))
                .timeout(timeout);
     ...
     */
    public static class Builder extends ImproveSchemaRestClient.Builder {
