...
public record AssistantMessage(
    ...
    /**
     * Compact constructor that enforces the assistant role and validates that at least one of {@code content}, {@code toolCalls}, or {@code refusal}
     * is present.
     */
    ...
    /**
     * Creates a new {@link AssistantMessage} with the assistant role applied automatically.
     *
     * @param content the assistant's message content
     * @param thinking the assistant's reasoning or internal thought process
     * @param name optional name to differentiate between assistant participants
     * @param refusal an optional refusal message when the assistant declines to perform a task
     * @param toolCalls optional tool calls generated by the model
     */
