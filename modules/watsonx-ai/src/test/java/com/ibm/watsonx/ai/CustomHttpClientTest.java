...
public class CustomHttpClientTest {
    ...
    void should_use_custom_http_client_for_embedding_service() throws Exception {
        ...
        Object asyncCosHttpClient = getFieldValue(restclient, "asyncHttpClient");
    ...
    @Test
    void should_use_custom_http_client_for_create_schema_service() throws Exception {
    ...
    @Test
    void should_use_custom_http_client_for_file_service() throws Exception {
    ...
    @Test
    void should_use_default_http_client_for_file_service() throws Exception {
    ...
    @Test
    void should_use_custom_http_client_for_model_gateway_embedding_service() throws Exception {
    ...
    @Test
    void should_use_default_http_client_for_model_gateway_embedding_service() throws Exception {
