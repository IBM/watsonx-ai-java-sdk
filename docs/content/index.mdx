...
| **[Embedding](services/model-gateway/embeddings)** | Generate vector embeddings from text using any configured embedding model |
...
| **[Project](services/project-service)** | Retrieve project metadata |
