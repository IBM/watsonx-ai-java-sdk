      ...
      items: [
        {
          ...
          items: [
            ...
            { type: 'doc', id: 'services/foundation-model-service', label: 'Foundation Model' },
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            { type: 'doc', id: 'services/model-gateway/embeddings',       label: 'Embedding' },
        ...
        },
        {
          ...
          link: { type: 'doc', id: 'services/document-processing/index' },
          collapsed: true,
          items: [
            {
              type: 'category',
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { type: 'doc', id: 'services/tool-service',         label: 'Tool' },
