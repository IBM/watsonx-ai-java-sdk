...
public class AiService {
    ...
    private static final String DEFAULT_MODEL_ID = "ibm/granite-4-h-small";
    ...
    private static final ChatParameters PARAMETERS = ChatParameters.builder()
    ...
    public AiService() {
        ...
        chatService = ChatService.builder()
            ...
            .toolInterceptor((ctx, fc) -> fc.arguments().startsWith("\"") ? fc.withArguments(Json.fromJson(fc.arguments(), String.class)) : fc)
            .build();
    ...
    public String chat(String userInput) {
        ...
        if (assistantMessage.hasToolCalls()) {
            var toolMessages = assistantMessage.processTools(
