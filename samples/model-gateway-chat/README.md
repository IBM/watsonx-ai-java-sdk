...
| `WATSONX_MODEL_ID`  | Yes      | The gateway model to use, in `provider/model` form (for example `/gpt-4o`) or the alias configured by your administrator |
...
export WATSONX_MODEL_ID=gpt-4o-mini
```
...
set WATSONX_MODEL_ID=gpt-4o-mini
```
